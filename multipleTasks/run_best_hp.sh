...
#running code with lower weight decay
echo "5.0 Running train.py --epoch $epochs --batch_size $batch_size2"
python3 ./train.py --resume --epoch $epochs --batch_size $batch_size2 --data_root ../../datasets_dir/ROD-synROD/
clear

#running code with lower weight decay
echo "5.1 Running train.py --epoch $epochs --batch_size $batch_size2  --weight_decay $weight_decay2 --lr $lr2"
...
python3 ./train_best_hp.py --resume --epoch $epochs --batch_size $batch_size --data_root ../../datasets_dir/ROD-synROD/ --weight_decay $weight_decay2 --lr $lr2
clear

#running code with lower weight decay
echo "8 Running train_best_hp.py --epoch $epochs --batch_size $batch_size2 --weight_decay $weight_decay2"
python3 ./train_best_hp.py --resume --epoch $epochs --batch_size $batch_size --data_root ../../datasets_dir/ROD-synROD/ --weight_decay $weight_decay2 
clear

#running code with lower weight decay
echo "9 Running train_best_hp.py --epoch $epochs --batch_size $batch_size2 --weight_decay $weight_decay2"
python3 ./train_best_hp.py --resume --epoch $epochs --batch_size $batch_size --data_root ../../datasets_dir/ROD-synROD/ --lr $lr2
clear
